...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR,'mybubble/templates')],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
####AWS Access credentials for Admin
#AWS_ACCESS_KEY_ID = os.environ['AWS_ACCESS_KEY_ID']
#AWS_SECRET_ACCESS_KEY = os.environ['AWS_SECRET_ACCESS_KEY']

####AWS Access credentials for User
#AWS_ACCESS_KEY_ID = os.environ['AWS_ACCESS_KEY_ID_USER']
#AWS_ACCESS_KEY_ID = 'AKIAJABVOWD2HG5TRHBA'
AWS_ACCESS_KEY_ID = 'AKIA6HDDZIKCEWLKDRPZ'
...
AWS_SECRET_ACCESS_KEY = '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'
